...
class CPFNet(nn.Module):
    def __init__(self,in_ch=1,out_ch=1,ccm=True,norm_layer=nn.BatchNorm2d,is_training=True,expansion=2,base_channel=32):
        super(CPFNet,self).__init__()
        
        self.backbone =resnet34(in_ch,pretrained=False)
        ...
        self.main_head= BaseNetHead(spatial_ch[0], out_ch, 2,
